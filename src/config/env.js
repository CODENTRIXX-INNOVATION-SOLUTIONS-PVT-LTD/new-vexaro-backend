...
const env = {
  ...
  SMTP_AUTH_METHOD: process.env.SMTP_AUTH_METHOD || '',
  SMTP_VERIFY_ON_STARTUP: process.env.SMTP_VERIFY_ON_STARTUP === 'true',
  SMTP_USER: process.env.SMTP_USER || '',
  SMTP_PASS: process.env.SMTP_PASS || '',
  CONTACT_TO_EMAIL: process.env.CONTACT_TO_EMAIL || process.env.EMAIL_FROM,
  CONTACT_FROM_EMAIL: process.env.CONTACT_FROM_EMAIL || process.env.EMAIL_FROM,
  CONTACT_RATE_LIMIT_WINDOW_MINUTES: parseInt(process.env.CONTACT_RATE_LIMIT_WINDOW_MINUTES || '15', 10),
  CONTACT_RATE_LIMIT_MAX: parseInt(process.env.CONTACT_RATE_LIMIT_MAX || '10', 10),
